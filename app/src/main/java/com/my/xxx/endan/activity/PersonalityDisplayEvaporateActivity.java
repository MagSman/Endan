...
public class PersonalityDisplayEvaporateActivity extends AppCompatActivity {

    @BindView(R.id.fall1)
    EvaporateTextView fall1;
    @BindView(R.id.fall2)
    ...
    public static void startIntent(Context context) {
        Intent intent = new Intent(context, PersonalityDisplayEvaporateActivity.class);
